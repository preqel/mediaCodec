 ...
 * Description:
 */
public class TriRender implements GLSurfaceView.Renderer {
   //三个顶点
   ...
   public   TriRender(Context context) {
   ...
   public void onSurfaceCreated(GL10 unused, EGLConfig config) {
      ...
      //编译顶点着色程序
      String vertexShaderStr = readResource(context, R.raw.triangle_vertext_shader);
      int vertexShaderId = compileVertexShader(vertexShaderStr);
      //编译片段着色程序
      String fragmentShaderStr = readResource(context, R.raw.triangle_fragment_shader);
