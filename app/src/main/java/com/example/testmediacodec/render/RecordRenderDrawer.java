...
public class RecordRenderDrawer extends BaseRenderDrawer implements Runnable{
    ...
    public void setInputTextureId(int textureId) {
        ...
        Log.d(LogUtil.TAG, "setInputTextureId: " + textureId);
    }
    ...
    public void startRecord() {
        Log.d(LogUtil.TAG, "startRecord context : " + mEglContext.toString());
    ...
    private void prepareVideoEncoder(EGLContext context, int width, int height) {
        try {
            ...
            mVideoEncoder = new VideoEncoder(400, 400, new File(mVideoPath));
    ...
    private void drawFrame(long timeStamp) {
        Log.d(LogUtil.TAG, "drawFrame: " + timeStamp );
    ...
    protected void onCreated() {
        ...
        Log.d(LogUtil.TAG, "onCreated: av_Position " + av_Position);
        Log.d(LogUtil.TAG, "onCreated: af_Position " + af_Position);
        Log.d(LogUtil.TAG, "onCreated: s_Texture " + s_Texture);
        Log.e(LogUtil.TAG, "onCreated: error " + GLES30.glGetError());
    }
