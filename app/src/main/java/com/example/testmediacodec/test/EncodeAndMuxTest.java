package com.example.testmediacodec.test;
...
/**
 * Created by QJMOTOR on 2024/11/9.
 */
public class EncodeAndMuxTest extends ComponentActivity{
    ...
    private void prepareEncoder() throws IOException {
      ...
      // String outputPath =  StorageUtil.getVedioPath(true) + "test"+ mWidth+"x"+ mHeight+".mp4";
        String outputPath =  StorageUtil.getVedioPath(true) + "dvrt.mp4";
...
//                "test" + mWidth + "x" + mHeight + ".mp4").toString();
    ...
    private static String[] PERMISSIONS_STORAGE = {
      ...
      final String myTAG ="EncodeAndrMuxTest";
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int permission = ActivityCompat.checkSelfPermission(EncodeAndMuxTest.this,"android.permission.WRITE_EXTERNAL_STORAGE");
        if (permission != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(EncodeAndMuxTest.this, PERMISSIONS_STORAGE,0);
        } else {
            Log.d(myTAG, "beforetest");
            try {
